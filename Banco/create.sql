...
CREATE TABLE IF NOT EXISTS `PETS`.`SEXO` (
  ...
  `SGSEXO` VARCHAR(1) NOT NULL,
  PRIMARY KEY (`SQSEXO`),
  UNIQUE INDEX `SGSEXO_UNIQUE` (`SGSEXO` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `PETS`.`SEXOANIMAL` (
  ...
  `NMNOME` VARCHAR(100) NOT NULL,
  `SGSEXOANIMAL` VARCHAR(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PETS`.`CAIXA` (
  ...
  `SQFUNCIONARIO` INT NOT NULL,
  PRIMARY KEY (`SQCAIXA`),
  INDEX `fk_CAIXA_CLIENTE1_idx` (`SQCLIENTE` ASC),
  INDEX `fk_CAIXA_FUNCIONARIO1_idx` (`SQFUNCIONARIO` ASC),
