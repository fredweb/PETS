...
namespace XNuvem.Linq
{
    ...
    /// Update by Davi Freitasbase on http://www.codeproject.com/Articles/493917/Dynamic-Querying-with-LINQ-to-Entities-and-Express
    /// </summary>
    public static class PredicateBuilder
    {
        ...
        /// <returns></returns>
        public static Expression<Func<T, bool>> OrStartsWith<T>(this Expression<Func<T, bool>> expr1, string propertyName, string value) {
            ...
            var memberInfo = typeof(T).GetMember(propertyName, BindingFlags.GetProperty | BindingFlags.Public | BindingFlags.Instance).Single();
