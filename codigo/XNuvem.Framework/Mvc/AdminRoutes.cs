    ...
    public static class AdminRoutes
    {
        public static void RegisterRoutes(RouteCollection routes, IEnumerable<Assembly> assemblies) {
            var controllers = assemblies
                ...
                .Where(t => !t.IsAbstract && typeof(Controller).IsAssignableFrom(t) && t.IsDefined(typeof(AdminAttribute)))
                .ToList();
        ...
        internal static RouteBase MapRoute(RouteCollection routes, Type adminType) {
            ...
            if (!string.IsNullOrEmpty(adminAtt.AreaName)) {
                route.DataTokens.Add("area", adminAtt.AreaName);
            }
            return route;
        }
