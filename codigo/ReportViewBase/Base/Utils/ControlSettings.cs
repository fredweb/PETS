...
namespace ReportViewBase.Base.Utils
{
    public class ControlSettings
    {
        ...
        /// <summary>
        ///     Gets or sets the target window or frame for the Web page content that is returned when a hyperlink in the report is
        ///     clicked.
        /// </summary>
        [UriParameter ( "_4" )]
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether the button that shows and collapses the document map is visible on the
        ///     split bar.
        /// </summary>
        [UriParameter ( "_14" )]
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether the button that shows and collapses the prompt area is visible on the
        ///     split bar.
        /// </summary>
        [UriParameter ( "_20" )]
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether the ReportViewer control should automatically resize to accommodate
        ///     report content.
        /// </summary>
        [UriParameter ( "_26" )]
        ...
        /// <summary>
        ///     Gets or sets a Boolean value that indicates whether to keep the user session from expiring as long as the Web page
        ///     is displayed in the browser.
        ///     By default this property is set to false because of
        ///     http://stackoverflow.com/questions/18491223/ssrs-why-do-ska-cookies-build-up-until-http-400-bad-request-request-too-long
        ...
        /// <summary>
        ///     Gets or sets a Boolean value that indicates whether the report is rendered asynchronously from the rest of the Web
        ///     page when the Web page is being loaded.
        /// </summary>
        [UriParameter ( "_35" )]
        ...
        /// <summary>
        ///     Gets or sets a value that indicates the time, in seconds, before asynchronous postbacks time out if no response is
        ///     received.
        /// </summary>
        [UriParameter ( "_42" )]
